  ...
  return (
    <main className="invite-page mx-auto min-h-[100vh] max-w-[430px] bg-cream relative overflow-hidden">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-start pt-32 px-6 text-center z-10">
        ...
        {/* Sakura Branch - positioned in the upper-left, extending horizontally with mix-blend-mode to multiply onto watercolor background */}
        <div className="absolute left-0 top-0 w-[80%] max-w-[340px] pointer-events-none z-20 mix-blend-multiply select-none">
          <Image
        ...
        {/* Flying Swallow Bird - floating on the right side of the screen facing the sakura branch */}
        <motion.div
          initial={{ opacity: 0, x: 50, y: -20 }}
          animate={{ opacity: 1, x: 0, y: 0 }}
          transition={{ duration: 1.2, ease: "easeOut", delay: 0.5 }}
          className="absolute right-8 top-32 w-[90px] pointer-events-none z-20 mix-blend-multiply select-none"
        >
          <motion.div
            animate={{ 
              y: [0, -6, 0],
        ...
        <div className="relative mt-auto mb-24 z-30 flex flex-col items-center">
          {/* We will build the names and main titles in this block next */}
        </div>

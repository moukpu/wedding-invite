    ...
    <main className="invite-page mx-auto min-h-[100vh] max-w-[430px] bg-cream relative overflow-hidden">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-between pt-32 pb-16 px-6 text-center z-10">
        ...
        <motion.div
          ...
          className="absolute right-[1.5%] top-[75px] w-[90px] pointer-events-none z-20 select-none"
        >
          <motion.div
            animate={{ 
              y: [0, -5, 0],
        ...
        <div className="relative flex flex-col items-center justify-center my-auto -mt-12 w-full max-w-[320px] z-30">
          ...
          <div className="relative z-10 flex flex-col items-center w-full select-none">
            <motion.span 
              ...
              className="font-cursive text-[76px] text-dark leading-none -translate-x-[45px] -translate-y-2"
            >
              Ринат
            </motion.span>
            ...
            <motion.span 
              ...
              className="font-cursive text-[76px] text-dark leading-none translate-x-[45px] mt-12"
            >
              Динара
            </motion.span>
          </div>
